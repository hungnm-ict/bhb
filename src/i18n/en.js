export default {
  ...
  'queue.hint':
    'Runs top to bottom, skips what is out of resources, and starts again. Tag actions to an activity in the Actions tab.',

  'settings.profiles': 'Profiles',
  'settings.profilesHint':
    'A profile holds its own actions, screens and queue — one per character. A second account just needs a second browser profile.',
