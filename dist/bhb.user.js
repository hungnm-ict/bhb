...
(() => {
  ...
  var vi_default = {
    ...
    "tasks.resetClockHint": "Kéo đồng hồ của game về đúng giờ thật. Nên làm trước khi đổi tài khoản: mang vài tiếng trôi sẵn sang nhân vật khác chính là thứ khiến game phát quà hằng ngày dù chưa sang ngày.",
    ...
    "settings.clockSafety": "Kéo đồng hồ game về giờ thật khi tốc độ trở lại 1×",
      ...
      section(
        ...
        () => el("div", { class: "bhb-field" }, [
          ...
          toggleRow(
            "settings.clockSafety",
            settings.clockSafety,
            (value) => deps.updateSettings({ clockSafety: value })
          ),
          toggleRow(
            "settings.fpsBadge",
            settings.fpsBadge,
